...
export default function Arm({ position = [0, 0, 0], scale = 1.25, vars: customVars }) {
  const storeVars = useActiveVars();
  const vars = customVars || storeVars;
