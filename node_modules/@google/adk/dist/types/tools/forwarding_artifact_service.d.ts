...
import { ArtifactVersion, BaseArtifactService, DeleteArtifactRequest, ListArtifactKeysRequest, ListVersionsRequest, LoadArtifactRequest, SaveArtifactRequest } from '../artifacts/base_artifact_service.js';
...
export declare class ForwardingArtifactService implements BaseArtifactService {
    ...
    listArtifactKeys(_request: ListArtifactKeysRequest): Promise<string[]>;
    private getArtifactService;
