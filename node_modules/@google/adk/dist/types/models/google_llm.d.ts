...
declare const GEMINI_MODEL_SYMBOL: unique symbol;
/**
 ...
 */
export declare function isGemini(obj: unknown): obj is Gemini;
/**
...
export declare class Gemini extends BaseLlm {
     ...
     */
    constructor({ model, apiKey, vertexai, project, location, headers, useInteractionsApi, }: GeminiParams);
    /**
