 ...
 * used for session resumption across tool and LRO boundaries.
 */
export declare function determineAgentForResumption(session: Session, rootAgent: BaseAgent, resumabilityConfig?: ResumabilityConfig): BaseAgent;
/**
 * Whether the agent to run can transfer to any other agent in the agent tree.
 *
 ...
 * @returns True if the agent can transfer, False otherwise.
 */
export declare function isRoutableLlmAgent(agentToRun: BaseAgent): boolean;
/**
 ...
 */
export declare function findEventByLastFunctionResponseId(events: Event[]): Event | null;
export {};
