...
let OperationParser = class {
  ...
  dedupeParamNames() {
    ...
    for (const param of this.params) {
      ...
      if (count > 0) {
        param.name = "".concat(name, "_").concat(count);
      }
  ...
  getJsonSchema() {
    ...
    return {
      ...
      title: "".concat(this.operation.operationId || "unnamed", "_Arguments")
    };
  }
  getFunctionName() {
