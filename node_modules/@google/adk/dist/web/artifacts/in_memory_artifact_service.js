...
function artifactPath(appName, userId, sessionId, filename) {
  if (fileHasUserNamespace(filename)) {
    return "".concat(appName, "/").concat(userId, "/user/").concat(filename);
  }
  return "".concat(appName, "/").concat(userId, "/").concat(sessionId, "/").concat(filename);
}
