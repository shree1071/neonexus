...
function formatValue(value, isArtifact = false) {
  ...
  if (typeof value === "object" && value !== null) {
    ...
    try {
      ...
      throw new Error(
        "Failed to serialize value for instruction template: ".concat(e instanceof Error ? e.message : String(e))
      );
    }
  }
  return String(value);
