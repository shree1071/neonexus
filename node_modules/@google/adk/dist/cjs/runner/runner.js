...
__export(runner_exports, {
  Runner: () => Runner,
  determineAgentForResumption: () => determineAgentForResumption,
  findEventByLastFunctionResponseId: () => findEventByLastFunctionResponseId,
  isRoutableLlmAgent: () => isRoutableLlmAgent,
  isRunner: () => isRunner
});
...
var import_scoped_artifact_service = require("../artifacts/scoped_artifact_service.js");
...
class Runner {
  ...
  constructor(input) {
    ...
    this.pluginManager = new import_plugin_manager.PluginManager([...appPlugins, ...configPlugins]);
      ...
      yield* (0, import_tracing.runAsyncGeneratorWithOtelContext)(
        ...
        async function* () {
          ...
          const invocationContext = new import_invocation_context.InvocationContext({
            artifactService: this.artifactService ? new import_scoped_artifact_service.ScopedArtifactService(
...
function determineAgentForResumption(session, rootAgent, resumabilityConfig) {
  ...
  for (let i = session.events.length - 1; i >= 0; i--) {
    import_logger.logger.debug("event:", JSON.stringify(session.events[i]));
...
function findEventByLastFunctionResponseId(events) {
  var _a2;
  return (_a2 = (0, import_functions.findMatchingFunctionCall)(events)) != null ? _a2 : null;
}
