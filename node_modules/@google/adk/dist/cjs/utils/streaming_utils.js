...
var import_feature_registry = require("../features/feature_registry.js");
var import_llm_response = require("../models/llm_response.js");
/**
 * @license
 * Copyright 2026 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const UNSAFE_PROPERTY_KEYS = /* @__PURE__ */ new Set(["__proto__", "constructor", "prototype"]);
class ProgressiveStrategy {
  ...
  getValueFromPartialArg(partialArg, jsonPath) {
    ...
    if (stringValue !== void 0) {
      ...
      hasValue = true;
      const pathParts = import_jsonpath_plus.JSONPath.toPathArray(jsonPath).filter(
        (p) => p !== "$" && p !== "$["
      );
    ...
    if (this.currentFcName) {
      const fcPart = {
        functionCall: {
          ...
          id: (_a = this.currentFcId) != null ? _a : (0, import_functions.generateClientFunctionCallId)()
        }
      };
...
class StreamingResponseAggregator {
  ...
  async *processResponse(response) {
    ...
    if (parts.every(isEmptyContentPart) && (llmResponse.finishReason === void 0 || llmResponse.finishReason === import_genai.FinishReason.STOP)) {
  ...
  close() {
    ...
    const hasMetadata = this.usageMetadata !== void 0 || this.groundingMetadata !== void 0 || this.citationMetadata !== void 0;
    ...
    return {
      ...
      content: finalParts ? { role: "model", parts: finalParts } : void 0,
