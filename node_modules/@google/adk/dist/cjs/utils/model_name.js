...
__export(model_name_exports, {
  ...
  isGemini3xFlashLive: () => isGemini3xFlashLive,
  isGeminiModel: () => isGeminiModel,
  isGeminiModelIdCheckDisabled: () => isGeminiModelIdCheckDisabled
});
...
function isGemini3xFlashLive(modelString) {
  if (!modelString) {
    return false;
  }
  const modelName = extractModelName(modelString);
...
function isGeminiModelIdCheckDisabled() {
  return (0, import_env_aware_utils.getBooleanEnvVar)("ADK_DISABLE_GEMINI_MODEL_ID_CHECK");
}
