...
let RunSkillScriptTool = class extends import_base_tool.BaseTool {
  ...
  async runAsync({
    ...
    try {
      ...
      return {
        error: `Failed to fetch skill '${skillName}' from registry: ${e.message || e}`,
