...
var import_search_skills_tool = require("./search_skills_tool.js");
/**
 * @license
 * Copyright 2026 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
let SkillToolset = class extends import_base_toolset.BaseToolset {
  constructor(skills, options = {}) {
    ...
    this.fetchedSkillCache = /* @__PURE__ */ new Map();
    ...
    if (this.registry) {
      this.tools.push(new import_search_skills_tool.SearchSkillsTool(this));
    }
  }
  ...
  async getOrFetchSkill(name, invocationId) {
    if (this.skills[name]) {
      return this.skills[name];
    }
    if (!this.registry) {
    ...
    if (!this.fetchedSkillCache.has(contextKey)) {
      this.fetchedSkillCache.set(contextKey, /* @__PURE__ */ new Map());
    }
    ...
    try {
      ...
      import_logger.logger.warn(`Failed to fetch skill '${name}' from registry: ${e}`);
      throw e;
    }
  }
  async processLlmRequest(toolContext, llmRequest) {
    ...
    (0, import_llm_request.appendInstructions)(llmRequest, instructions);
  }
