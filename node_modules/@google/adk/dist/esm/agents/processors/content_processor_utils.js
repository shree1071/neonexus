...
function removeClientFunctionCallId(content) {
  ...
  for (const part of (_a = content == null ? void 0 : content.parts) != null ? _a : []) {
    if ((_c = (_b = part.functionCall) == null ? void 0 : _b.id) == null ? void 0 : _c.startsWith(AF_FUNCTION_CALL_ID_PREFIX)) {
      part.functionCall.id = void 0;
    }
    if ((_e = (_d = part.functionResponse) == null ? void 0 : _d.id) == null ? void 0 : _e.startsWith(AF_FUNCTION_CALL_ID_PREFIX)) {
...
function convertForeignEvent(event) {
  ...
  for (const part of event.content.parts) {
    if (part.text && !part.thought) {
      ...
      (_f = content.parts) == null ? void 0 : _f.push(cloneDeep(part));
    }
  }
  return createEvent({
...
function mergeFunctionResponseEvents(events) {
  ...
  const mergedEvent = createEvent({
    ...events[0],
    content: events[0].content ? cloneDeep(events[0].content) : void 0
  });
