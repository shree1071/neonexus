...
class StreamingResponseAggregator {
  ...
  async *processResponse(response) {
    ...
    if (parts.every(isEmptyContentPart) && (llmResponse.finishReason === void 0 || llmResponse.finishReason === FinishReason.STOP)) {
