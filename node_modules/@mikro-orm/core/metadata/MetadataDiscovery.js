...
class MetadataDiscovery {
    ...
    sameRelationTargetRoot(rootProp, prop) {
        ...
        if (prop.kind !== enums_1.ReferenceKind.MANY_TO_ONE &&
            ...
            prop.kind !== enums_1.ReferenceKind.ONE_TO_MANY &&
    ...
    initSingleTableInheritance(meta, metadata) {
        ...
        Object.values(meta.properties).forEach(prop => {
            ...
            const isInverseSideRelation = prop.kind === enums_1.ReferenceKind.ONE_TO_MANY || (prop.kind === enums_1.ReferenceKind.MANY_TO_MANY && !prop.owner);
            if (rootProp && !narrowedRelationOverride && !isInverseSideRelation && (rootProp.type !== prop.type || (rootProp.fieldNames && prop.fieldNames && !(0, Utils_1.compareArrays)(rootProp.fieldNames, prop.fieldNames)))) {
    ...
    initCustomType(meta, prop, simple = false) {
