...
exports.Utils = exports.DANGEROUS_PROPERTY_NAMES = exports.ObjectBindingPattern = void 0;
...
const ArrayCollection_1 = require("../entity/ArrayCollection");
 ...
 * @internal
 */
exports.DANGEROUS_PROPERTY_NAMES = ['__proto__', 'constructor', 'prototype'];
...
function isRawSql(value) {
    return RawQueryFragment_1.RawQueryFragment.isRaw(value);
}
...
class Utils {
    ...
    static _merge(target, sources, ignoreUndefined) {
        ...
        if (Utils.isObject(target) && Utils.isPlainObject(source)) {
            for (const [key, value] of Object.entries(source)) {
                if (exports.DANGEROUS_PROPERTY_NAMES.includes(key)) {
                    continue;
                }
    ...
    static isEntity(data, allowReference = false) {
        ...
        if (allowReference && Reference_1.Reference.isReference(data)) {
            return true;
        }
        return EntityHelper_1.EntityHelper.isEntity(data);
    }
    /**
     * Checks whether given object is a scalar reference.
     */
    static isScalarReference(data) {
        return Reference_1.ScalarReference.isScalarReference(data);
    }
    /**
    ...
    static isCollection(item) {
        return ArrayCollection_1.ArrayCollection.isCollection(item);
    }
    ...
    static resolveModulePath(id, from = process.cwd()) {
        ...
        const path = Utils.normalizePath((0, node_module_1.createRequire)((0, node_path_1.resolve)(from)).resolve(id));
